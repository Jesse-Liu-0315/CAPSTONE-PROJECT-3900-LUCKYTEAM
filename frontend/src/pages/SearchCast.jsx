...
import SearchResultCast from '../components/SearchResultCast';
...
const SearchCast = () => {
  ...
  React.useEffect(() => {
    ...
    try {
      makeRequest('/search/cast', 'POST', body).then(data => {
        setSearchResult(data.casts);
    ...
    <>
      ...
      <div className="container-fluid">
        ...
        <div className='row'>
          ...
          <div className="col">
            <Box sx={{ marginTop: '2px', marginRight: '5px', float: 'left', width: 3, height: 30, backgroundColor: 'primary.dark' }} />
            <h3 style={{ fontWeight: 'bold', cursor: 'default' }}>Cast</h3>
          </div>
          <div className="col">
            <Box sx={{ marginTop: '2px', marginRight: '5px', float: 'left', width: 3, height: 30, backgroundColor: 'primary.dark' }} />
        ...
        {searchResult.map((result, index) => {
          return <SearchResultCast key={index} castId={result.star_id} castPhoto={result.star_cover} castName={result.star_name} castDescription={result.star_description} castViews={result.star_views} castPerformances={result.numOfPerformances}></SearchResultCast>
        })}
