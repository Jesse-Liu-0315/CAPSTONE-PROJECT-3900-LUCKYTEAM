...
const OtherPeopleWishListMovie = (props) => {
          ...
          <div className="row g-0">
            ...
            <div className="col">
              <div className="card-body" style={{ position:'relative', height: '100%', padding: '0px', paddingLeft: '5px' }}>
                ...
                <Rating value={props.movieRating === null ? 0 : props.movieRating} readOnly style={{ position:'absolute', bottom: 20, margin: '0px'}}/>
...
OtherPeopleWishListMovie.propTypes = {
...
export default OtherPeopleWishListMovie;